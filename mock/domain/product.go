...
// Source: application/domain/product.go
...
func (m *MockProductServiceInterface) Create(name string, price float32) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, price)
	ret0, _ := ret[0].(domain.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(product domain.ProductInterface) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(product domain.ProductInterface) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Get(id string) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductReader) Get(id string) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(domain.ProductInterface)
	ret1, _ := ret[1].(error)
...
func (m *MockProductWriter) Save(product domain.ProductInterface) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductPersistenceInterface) Get(id string) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(domain.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(product domain.ProductInterface) (domain.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(domain.ProductInterface)
	ret1, _ := ret[1].(error)
